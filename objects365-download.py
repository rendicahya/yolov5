...
# Make Directories
dir = Path("/nas.dbms/randy/datasets/objects365")  # dataset root dir
            ...
            try:
                with open(labels / path.with_suffix(".txt").name, "a") as file:
                    annIds = coco.getAnnIds(
                        imgIds=im["id"], catIds=catIds, iscrowd=False
                    )
                    for a in coco.loadAnns(annIds):
                        ...
                        x, y, w, h = xyxy2xywhn(xyxy, w=width, h=height, clip=True)[
                            0
